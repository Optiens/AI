...
export const knowledgeDocs: KnowledgeDoc[] = [
  ...
  },
  {
    ...
    visibility: 'demo-safe',
    maturity: 'operational',
    summary: '無料診断から詳細レポート、AI診断官β、スポット相談、導入支援へ進めるための標準フロー。',
    tags: ['無料診断', '詳細レポート', '導入支援', '営業'],
    body: [
      '入口は無料診断フォーム。AIで一次診断レポートを作成し、顧客に具体的な業務改善の方向性を示す。',
      '詳細レポートは税込5,500円の自動有償レポートとして扱う。汎用AIへの相談代行ではなく、フォーム回答をOptiensの診断基準で整理し、優先順位、やらないこと、費用前提、次の一手を導入判断資料として残す。AI診断官βは入口、体験デモ、追加ヒアリング、診断メモ化による詳細版の価値増強に使う。人間の相談が必要な場合はスポット相談チケットの単発AI相談へ分ける。',
      '導入支援は個別見積。対象業務、連携先、データ状態、運用担当者を確認してから提案する。',
      '保守は月額契約として、改善、障害対応、運用定着を支える。',
    ].join('\n'),
  },
  {
    id: 'ai-adoption-retention-package-draft',
    title: 'AI運用定着パッケージ商品設計案',
    category: 'sales',
    owner: 'COO / CMO',
    updatedAt: '2026-05-16',
    visibility: 'internal',
    maturity: 'seed',
    summary: 'FUSION AI案内資料の示唆をもとにした、未公開・未実装の商品設計案。スターター、スタンダード、社内AI担当者育成ミニ講座を記録する。',
    tags: ['AI運用定着', '商品設計', '研修', '社内AI担当者', '未公開'],
    body: [
      '正本は executive/ai-consulting/AI運用定着パッケージ_商品設計案_v0.1.md。現時点では記録のみで、公開ページ、営業導線、価格表、メール文面には反映しない。',
      '位置付けは、既存ファネル「無料診断、詳細版AI活用診断、AI診断官β、スポット相談、有償要件定義、導入支援、保守」に追加できる定着支援案。保守がシステム修正・改善を扱うのに対し、定着支援は人、ルール、習慣を扱う。',
      '商品案1はAI運用定着スターター。4週間、¥120,000税抜 / ¥132,000税込。キックオフ、実務テンプレート5本、AI利用ルール簡易版、業務別AI活用マップ、週次フォロー、最終レポートを含む。',
      '商品案2はAI運用定着スタンダード。3ヶ月、¥300,000税抜 / ¥330,000税込。月次定着MTG、隔週ミニレビュー、業務テンプレート10本、AI利用ルール、AI活用ログ、定着KPI、最終レポートを含む。',
      '商品案3は社内AI担当者育成ミニ講座。2週間、¥66,000税込。オンライン講座2回、業務テンプレート3本、AI利用チェックリスト、非同期質問3件までを含む。',
      '初期リリース方針は、まずスターターを非公開メニューとして月2社上限で検証する。スターター3件以上、内部工数8時間以内、継続利用確認、導入支援または保守への転換1件以上を公開検討条件とする。',
      '外部API連携、認証、個人情報、決済、本番システム構築、既存システム改修、24時間質問対応、成果保証は含めない。必要な場合はスポット相談チケット、導入支援、保守へ切り替える。',
    ].join('\n'),
  },
  {
    id: 'daily-ops',
  ...
  },
  {
    ...
    body: [
      ...
      'paidは詳細レポート作成へ進める。report_createdは送付し、report_sentまたはsentは必要に応じてAI診断官β、スポット相談、導入支援化をフォローする。',
    ].join('\n'),
  },
  {
    ...
    body: [
      ...
      'AI活用診断は、AI活用診断簡易版（無料）と詳細版AI活用診断（¥5,500税込）に分ける。詳細版の納品物名は「詳細レポート」。詳細版は汎用AI相談そのものではなく、Optiensの診断基準で優先順位、やらないこと、費用前提、次の一手を整理した導入判断資料として扱う。',
      '詳細版AI活用診断には60分MTGを含めない。レポート内容の補足ヒアリングはAI診断官βを入口にし、人間の相談が必要な場合は単発AI相談、導入支援前の範囲確定が必要な場合は有償要件定義として別導線で案内する。',
