...
image: '/images/blog/20260511-claude-code-5-integration-methods.webp'
---
...
ただし、速度・精度の面で他方式に劣るため、**最後の手段** として位置づけるのが妥当です。詳細は [Claude for Chrome 公式ページ](https://claude.com/claude-for-chrome) を参照してください。
