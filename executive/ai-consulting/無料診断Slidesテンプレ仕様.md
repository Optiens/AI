...
|---|---|---|
| 背景 | 純白 | `#FFFFFF` |
| 主要見出し | チタンブルー濃 | `#1F4D7A` |
| サブ見出し | チタンブルー | `#3D6FA0` |
| 本文 | ダークスレート | `#0f172a` |
| アクセント（強調・グラデ終点） | 桜 | `#E48A95` |
| カード背景 | 薄グレー | `#F9FAFB` |
| 罫線 | 境界線 | `#E5E7EB` |
| **グラデ** | チタンブルー → 桜 | `linear-gradient(135deg, #3D6FA0, #E48A95)` |
...
- **タイトル下にチタンブルー→桜のグラデーションライン**（1px、装飾アクセント）
...
- フッター: 「具体的な自動化提案は [詳細レポート（¥5,500税込）](https://optiens.com/free-diagnosis?paid=1) でお届けします」

### Slide 4: 自動化／人間残しの方向性（v2.1 新規）
- 左カラム: 「**AIに任せやすい業務**」（チタンブルー枠）
  - 業種に応じた汎用列挙
- 右カラム: 「**人間に残すべき業務**」（桜枠）
  - 業種に応じた汎用列挙
...
### Slide 7: ROI 試算
- 大きな数字: 「月 ¥XX,XXX」（チタンブルー濃、太字、48pt）
- 計算式表示:
  ```
