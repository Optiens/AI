...
Optiensでは、室内LED水耕栽培システムにおいてフルスペクトルLEDを採用し、PPFDとDLIを栽培パラメータとして管理しています。Zigbeeスマートスイッチによる照射時間の自動制御と、IoTセンサーによる環境データの継続的な記録を組み合わせることで、栽培サイクルごとに電力原単位（kWh/kg）を算出し、照明設定の最適化を進めています。
