...
### 段階 4: 安定したら Agent Skill に切り出す

特定の業務パターンが安定し、複数のフォルダで再利用したくなったら、**Agent Skill** という仕組みに切り出すこともできます。ただし、Agent Skill 化はアップデートがやや面倒なので、**「フォルダ内 `CLAUDE.md` で十分なら無理に切り出さない」** が実務的に楽です。
