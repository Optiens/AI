...
経営者・管理職・現場担当者が日々下している判断のうち、**マニュアル化・言語化されているのは 2 割以下** が一般的です。残り 8 割は「過去の失敗体験」「顧客との関係性」「組織の暗黙のルール」「業界慣習」など、本人が言葉にしない限り取り出せません。

AI に渡せる情報は、構築時点で言語化された 2 割だけ。残り 8 割は **使いながら少しずつ引き出して登録していく** しかありません。
