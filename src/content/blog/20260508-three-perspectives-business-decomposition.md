---
title: '業務分解の 3 つの視点 ── 鳥の目・虫の目・人の目で AI 化候補を見極める'
date: '2026-05-08'
category: 'business'
excerpt: 'AI 導入を成功させる前提は「業務の見える化」です。けれども見える化と一口に言っても、何をどの粒度で見るかが曖昧だと結局抜け漏れが起きます。本稿では業務を 3 つの視点（鳥の目・虫の目・人の目）で分解するフレームワークを紹介し、それぞれが AI 化判断にどう関わるかを整理します。'
...
御社の業務を、3 つの視点で一緒に棚卸ししませんか。Optiens の[無料 AI 活用診断](/free-diagnosis)では、ヒアリング時にこのフレームワークを必ず使い、AI 化候補と人材戦略候補を切り分けてご提案します。
