...
Claude Code には、操作の確認を毎回スキップする **Bypass モード**（バイパス権限モード）があります。設定 → Claude Code → 「バイパス権限モードを許可」で有効化できます。
...
公式の警告にも「データ損失・システム破損・データ流出のリスクがある」と明記されています。**「便利だから常用する」は事故の元** です。
