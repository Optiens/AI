...
あるクラウドソーシング企業は、最初から「何でもマッチング」と打ち出すと使われないと判断し、**ロゴコンペ専用** で立ち上げました。一般的な制作会社の料金体系では数案しか提示されない中、**コンペ形式で多数の案を提示できる**サービスとして差別化。会社設立直後で予算がない経営者にとって、これは「絶対欲しい」サービスでした。
