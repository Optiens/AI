...
date: '2026-04-17'
category: 'welfare'
excerpt: '令和4年度の平均工賃が月額約17,031円、令和5年度の新算定方法で月額約23,053円と、依然として最低賃金水準を大きく下回る就労継続支援B型事業所。室内LED水耕栽培との組み合わせが、高単価ハーブの自主製品販売・IoTによる管理効率化・園芸療法的効果を通じて、工賃向上と利用者QOL改善を同時に実現できる理由を解説する。'
image: '/images/blog/b-type-welfare-indoor-hydroponics-model.webp'
---

## 工賃17,000円の壁――B型事業所が直面する構造問題

就労継続支援 B 型事業所の平均工賃は、厚生労働省の調査によると令和 4 年度で月額約 17,031 円、令和 5 年度の新算定方法（分母を「一日あたりの平均利用者数」とした令和 6 年度報酬改定後の方式）でも月額約 23,053 円にとどまります。いずれも最低賃金（時給換算）と比較すると大きなギャップがあり、利用者の経済的自立を妨げる課題として長年指摘されてきました（算定方法変更があるため過年度との単純比較は不可）。
