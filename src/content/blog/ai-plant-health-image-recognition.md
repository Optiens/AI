...
植物病害の画像認識研究で広く利用されているのが、**PlantVillage データセット**です。トマト、ジャガイモ、リンゴなど 14 作物の 26 種類の病害を含む 38 クラスについて、健康な葉と病害に侵された葉の画像が約 54,305 枚収録されています。このオープンデータセットの登場により、研究者や開発者が植物診断 AI の開発に取り組むハードルが大きく下がりました。
...
ペンシルベニア州立大学と EPFL（スイス連邦工科大学ローザンヌ校）の共同研究チームは、PlantVillage データセットを用いた CNN モデルで、26 種類の病害を 99.35% の精度で識別することに成功しました（Mohanty et al., 2016, Frontiers in Plant Science）。また、インドの研究機関では、スマートフォンカメラの画像のみで水耕栽培レタスの栄養欠乏を判定するモデルが開発されています。

### 商用サービス

- **Plantix**: スマートフォンで葉を撮影するだけで病害虫や栄養不足を診断するアプリ。世界で 1,000 万ダウンロード超、月間アクティブユーザーは約 100 万人規模。対応作物は 30 種類以上で、コミュニティ機能で農家同士の情報共有も可能
