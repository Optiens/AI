...
**Google Business Profile API は「アクセス申請承認制」** であり、申請から承認まで通常 **1〜2 週間** かかります。

「来週から運用したい」というご相談に対しては、**この承認期間を含めたスケジュール設計** が必要です。
...
|---|---:|---|---|
| **Google Business Profile API** | 1〜2 週間 | プライバシーポリシー・用途記述 | Sandbox なし、本番前提 |
| **Instagram Graph API** | 2〜4 週間 | App Review 動画録画必須、用途デモ動画 | **Development mode** で自社 IG 検証可 |
...
- Google Business Profile API は無料だが **アクセス申請承認制**
- 承認まで通常 **1〜2 週間**、Instagram Graph API は **2〜4 週間**
